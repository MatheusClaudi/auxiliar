...
describe('workspace-project label-creation-remotion', () => {
  ...
  beforeAll(async () => {
    ...
    addUserPage.adduser("test", "test", "testlabels@testlabels.com", "testlabels", "testlabels", false)
...
/*
  ...
  it('should do a sucessful register of a label, and erase it after', async () => {
    await browser.waitForAngularEnabled(false);
